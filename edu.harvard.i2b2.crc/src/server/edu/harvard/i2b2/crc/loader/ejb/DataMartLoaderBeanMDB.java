	...
	//	TextMessage msg = null;
		...
		try {
			...
			//	msg = (TextMessage) inMessage;
				...
				password.setValue((String)msg.get(I2B2_PASSWORD)); //gnm
				password.setIsToken((Boolean)msg.get(I2B2_PASSWORD_ISTOKEN));
...
*/				
			...
			if(publishMessage == null)
				...
				updateUploadStatus(uploaderDaoFactory, uploadId, "PROCESSING",
				"");
				processUploadMessage(uploaderDaoFactory, userId, password,uploadId,
	...
	*/
	...
	public int processUploadMessage(IUploaderDAOFactory uploaderDaoFactory,
			String userId, PasswordType passWord , int uploadId, String localUploadFile,
			String publishMessage) throws I2B2Exception {
		dmLoader.setPassword(passWord);
