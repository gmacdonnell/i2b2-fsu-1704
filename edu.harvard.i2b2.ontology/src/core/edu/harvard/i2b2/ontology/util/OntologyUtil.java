...
public class OntologyUtil {
	...
	private static final String FRCELL_WS_SENDFILE_OPERATIONNAME_PROPERTIES = "edu.harvard.i2b2.ontology.ws.fr.sendFile";
	...
	public String getFileRepositorySendFileOperationName() throws I2B2Exception {
		return getPropertyValue(FRCELL_WS_SENDFILE_OPERATIONNAME_PROPERTIES);
	}
