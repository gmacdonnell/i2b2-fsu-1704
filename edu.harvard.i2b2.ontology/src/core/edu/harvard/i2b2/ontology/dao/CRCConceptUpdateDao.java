...
public class CRCConceptUpdateDao extends JdbcDaoSupport {
	...
	public OntologyProcessStatusType addUpdateConcept(ProjectType projectInfo,
		...
		try {
			...
			// poll upload status
//gnm			loadDataResponseType = CallCRCUtil
//gnm					.pollUploadStatus(loadDataResponseType.getUploadId());

			loadDataResponseType = CallCRCUtil
					.pollUploadStatus(loadDataResponseType.getUploadId(), securityType, projectId);
