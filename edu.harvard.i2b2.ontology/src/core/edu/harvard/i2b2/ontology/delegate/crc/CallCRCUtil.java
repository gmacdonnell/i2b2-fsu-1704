...
public class CallCRCUtil {
	...
	//gnm public static  LoadDataResponseType pollUploadStatus(String uploadId)
	public static  LoadDataResponseType pollUploadStatus(String uploadId, SecurityType securityType, String projectID)
			throws I2B2Exception {
		...
		//gnm
		uploadStatusRunner.setSecurityType(securityType);
		uploadStatusRunner.setProjectId(projectID);
